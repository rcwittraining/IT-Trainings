...
**RHCSA Certification Practice · Task 28 of 62 · Running Systems**

## Purpose

Perform a controlled restart sequence for SSH service and confirm that the service returns to an active state.
...
|---|---:|---|
| Assess the starting state | 20 | Network service status inspected |
| Stop, start and validate the network service | 60 | Network service stopped, Network service started |
| Validate the resulting state | 20 | Network service state validated |
