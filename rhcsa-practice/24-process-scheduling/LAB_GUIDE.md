# Process Scheduling Adjustment

**RHCSA Certification Practice · Task 24 of 62 · Running Systems**

## Purpose

Lower the CPU scheduling priority of a noncritical report renderer while leaving the process running.
...
|---|---:|---|
| Assess the starting state | 20 | Current scheduling values inspected |
| Adjust the running process priority | 60 | Nice value adjusted |
| Validate the resulting state | 20 | Adjusted scheduling state validated |
...
```bash
ps -o pid,ni,pri,comm --no-headers -p 4310
```
