# Multi-user Login and Identity Switching

**RHCSA Certification Practice · Task 05 of 62 · Essential Tools**

## Purpose

Review active sessions, switch into the application service account with its login environment, and confirm the resulting identity.
...
|---|---:|---|
| Assess the starting state | 20 | Active user sessions inspected |
| Switch safely to the service identity | 60 | Login environment switched to appsvc, Service identity and groups inspected |
| Validate the resulting state | 20 | Effective user validated |
