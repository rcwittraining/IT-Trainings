...
**RHCSA Certification Practice · Task 43 of 62 · System Maintenance**

## Purpose

Configure the server to boot into the non-graphical multi-user target by default without disrupting the current session.
...
|---|---:|---|
| Assess the starting state | 20 | Existing default target inspected |
| Set the persistent default systemd target | 60 | Persistent default target changed |
| Validate the resulting state | 20 | New default boot target validated |
